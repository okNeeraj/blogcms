...
e&&e.getTransaction()&&e.setSpan(void 0)}},98079:(t,e,n)=>{n.r(e),n.d(e,{BROWSER_TRACING_INTEGRATION_ID:()=>tt,BrowserTracing:()=>nt,IdleTransaction:()=>B.io,Integrations:()=>i,Span:()=>st.Dr,SpanStatus:()=>at,TRACEPARENT_REGEXP:()=>b.K,Transaction:()=>rt.Y,addExtensionMethods:()=>a.ro,defaultRequestInstrumentationOptions:()=>K,extractTraceparentData:()=>b.q,getActiveTransaction:()=>k.x1,hasTracingEnabled:()=>k.zu,instrumentOutgoingRequests:()=>V,spanStatusfromHttpCode:()=>st.Zd,startIdleTransaction:()=>a.lb,stripUrlQueryAndFragment:()=>o.rt})
var i={}
n.r(i),n.d(i,{Apollo:()=>R,BrowserTracing:()=>nt,Express:()=>p,GraphQL:()=>y,Mongo:()=>E,Mysql:()=>g,Postgres:()=>m,Prisma:()=>S})
var a=n(38285)
...
return n.call(this,...function(t,e){return t.map((t=>"function"==typeof t?l(t,e):Array.isArray(t)?t.map((t=>"function"==typeof t?l(t,e):t)):t))}(i,e))},t}(t,e)))}(this._router,this._methods),function(t){const e="settings"in t
...
for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n]
r.call(this,...e)}))}
default:throw new Error(`Express middleware takes 2-4 arguments. Got: ${n}`)}}p.__initStatic()
var u=n(30180),h=n(15834)
class m{static __initStatic(){this.id="Postgres"}__init(){this.name=m.id}constructor(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
m.prototype.__init.call(this),this._usePgNative=!!t.usePgNative}setupOnce(t,e){if(d(e))return void(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("Postgres Integration is skipped because of instrumenter configuration."))
const n=(0,u.$y)("pg")
...
const{Client:i}=this._usePgNative?n.native:n;(0,h.hl)(i.prototype,"query",(function(t){return function(n,i,a){const r=s([e().getScope(),"optionalAccess",t=>t.getSpan,"call",t=>t()]),o=s([r,"optionalAccess",t=>t.startChild,"call",t=>t({description:"string"==typeof n?n:n.text,op:"db"})])
...
return(0,_.J8)(c)?c.then((t=>(s([o,"optionalAccess",t=>t.finish,"call",t=>t()]),t))):(s([o,"optionalAccess",t=>t.finish,"call",t=>t()]),c)}}))}}m.__initStatic()
class g{constructor(){g.prototype.__init.call(this)}static __initStatic(){this.id="Mysql"}__init(){this.name=g.id}setupOnce(t,e){if(d(e))return void(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("Mysql Integration is skipped because of instrumenter configuration."))
const n=(0,u.$y)("mysql/lib/Connection.js")
n?(0,h.hl)(n,"createQuery",(function(t){return function(n,i,a){const r=s([e().getScope(),"optionalAccess",t=>t.getSpan,"call",t=>t()]),o=s([r,"optionalAccess",t=>t.startChild,"call",t=>t({description:"string"==typeof n?n:n.sql,op:"db"})])
return"function"==typeof a?t.call(this,n,i,(function(t,e,n){s([o,"optionalAccess",t=>t.finish,"call",t=>t()]),a(t,e,n)})):"function"==typeof i?t.call(this,n,(function(t,e,n){s([o,"optionalAccess",t=>t.finish,"call",t=>t()]),i(t,e,n)})):t.call(this,n,i,a)}})):("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.error("Mysql Integration was unable to require `mysql` package.")}}g.__initStatic()
...
const i=this._getSpanContextFromOperationArguments.bind(this);(0,h.hl)(t.prototype,e,(function(t){return function(){for(var a=arguments.length,r=new Array(a),o=0;o<a;o++)r[o]=arguments[o]
const c=r[r.length-1],d=s([n().getScope(),"optionalAccess",t=>t.getSpan,"call",t=>t()])
if("function"!=typeof c||"mapReduce"===e&&2===r.length){const n=s([d,"optionalAccess",t=>t.startChild,"call",t=>t(i(this,e,r))]),a=t.call(this,...r)
if((0,_.J8)(a))return a.then((t=>(s([n,"optionalAccess",t=>t.finish,"call",t=>t()]),t)))
if((p=a)&&"object"==typeof p&&p.once&&"function"==typeof p.once){const e=a
try{e.once("close",(()=>{s([n,"optionalAccess",t=>t.finish,"call",t=>t()])}))}catch(t){s([n,"optionalAccess",t=>t.finish,"call",t=>t()])}return e}return s([n,"optionalAccess",t=>t.finish,"call",t=>t()]),a}var p
const l=s([d,"optionalAccess",t=>t.startChild,"call",t=>t(i(this,e,r.slice(0,-1)))])
return t.call(this,...r.slice(0,-1),(function(t,e){s([l,"optionalAccess",t=>t.finish,"call",t=>t()]),c(t,e)}))}}))}_getSpanContextFromOperationArguments(t,e,n){const i={collectionName:t.collectionName,dbName:t.dbName,namespace:t.namespace},a={op:"db",description:e,data:i},s=T[e],r=Array.isArray(this._describeOperations)?this._describeOperations.includes(e):this._describeOperations
if(!s||!r)return a
try{if("mapReduce"===e){const[t,e]=n
i[s[0]]="string"==typeof t?t:t.name||"<anonymous>",i[s[1]]="string"==typeof e?e:e.name||"<anonymous>"}else for(let t=0;t<s.length;t++)i[s[t]]=JSON.stringify(n[t])}catch(t){}return a}}E.__initStatic()
...
return(0,_.J8)(c)?c.then((t=>(s([o,"optionalAccess",t=>t.finish,"call",t=>t()]),t))):(s([o,"optionalAccess",t=>t.finish,"call",t=>t()]),c)})):("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.error("PrismaIntegration is missing a Prisma Client Instance")}}S.__initStatic()
...
n?(0,h.hl)(n,"execute",(function(t){return function(){const n=e().getScope(),i=s([n,"optionalAccess",t=>t.getSpan,"call",t=>t()]),a=s([i,"optionalAccess",t=>t.startChild,"call",t=>t({description:"execute",op:"graphql.execute"})])
...
var v=n(7209)
class R{constructor(){R.prototype.__init.call(this)}static __initStatic(){this.id="Apollo"}__init(){this.name=R.id}setupOnce(t,e){if(d(e))return void(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("Apollo Integration is skipped because of instrumenter configuration."))
const n=(0,u.$y)("apollo-server-core")
...
return this.config.resolvers=n.map((t=>(Object.keys(t).forEach((n=>{Object.keys(t[n]).forEach((i=>{"function"==typeof t[n][i]&&function(t,e,n,i){(0,h.hl)(t[e],n,(function(t){return function(){const a=s([i().getScope(),"optionalAccess",t=>t.getSpan,"call",t=>t()]),r=s([a,"optionalAccess",t=>t.startChild,"call",t=>t({description:`${e}.${n}`,op:"graphql.resolve"})])
for(var o=arguments.length,c=new Array(o),d=0;d<o;d++)c[d]=arguments[d]
const p=t.call(this,...c)
return(0,_.J8)(p)?p.then((t=>(s([r,"optionalAccess",t=>t.finish,"call",t=>t()]),t))):(s([r,"optionalAccess",t=>t.finish,"call",t=>t()]),p)}}))}(t,n,i,e)}))})),t))),t.call(this)}})):("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.error("Apollo Integration was unable to require apollo-server-core package.")}}R.__initStatic()
var b=n(75492),D=n(22850),N=n(68256),B=n(27448),k=n(48206)
const G=n(27083).n2
var U=n(88468)
const Y=(t,e,n)=>{let i,a
return s=>{e.value>=0&&(s||n)&&(a=e.value-(i||0),(a||void 0===i)&&(i=e.value,e.delta=a,t(e)))}},x=()=>G.__WEB_VITALS_POLYFILL__?G.performance&&(performance.getEntriesByType&&performance.getEntriesByType("navigation")[0]||(()=>{const t=G.performance.timing,e=G.performance.navigation.type,n={entryType:"navigation",startTime:0,type:2==e?"back_forward":1===e?"reload":"navigate"}
for(const i in t)"navigationStart"!==i&&"toJSON"!==i&&(n[i]=Math.max(t[i]-t.navigationStart,0))
return n})()):G.performance&&performance.getEntriesByType&&performance.getEntriesByType("navigation")[0],I=()=>{const t=x()
return t&&t.activationStart||0},A=(t,e)=>{const n=x()
let i="navigate"
return n&&(i=G.document.prerendering||I()>0?"prerender":n.type.replace(/_/g,"-")),{name:t,value:void 0===e?-1:e,rating:"good",delta:0,entries:[],id:`v3-${Date.now()}-${Math.floor(8999999999999*Math.random())+1e12}`,navigationType:i}},C=(t,e,n)=>{try{if(PerformanceObserver.supportedEntryTypes.includes(t)){const i=new PerformanceObserver((t=>{e(t.getEntries())}))
return i.observe(Object.assign({type:t,buffered:!0},n||{})),i}}catch(t){}},O=(t,e)=>{const n=i=>{"pagehide"!==i.type&&"hidden"!==G.document.visibilityState||(t(i),e&&(removeEventListener("visibilitychange",n,!0),removeEventListener("pagehide",n,!0)))}
addEventListener("visibilitychange",n,!0),addEventListener("pagehide",n,!0)}
let w=-1
const $=()=>(w<0&&(w="hidden"!==G.document.visibilityState||G.document.prerendering?1/0:0,O((t=>{let{timeStamp:e}=t
w=e}),!0)),{get firstHiddenTime(){return w}}),L={}
function M(t){return"number"==typeof t&&isFinite(t)}function P(t,e){let{startTimestamp:n,...i}=e
return n&&t.startTimestamp>n&&(t.startTimestamp=n),t.startChild({startTimestamp:n,...i})}function q(){return G&&G.addEventListener&&G.performance}let H,F,j=0,z={}
function X(t,e,n,i,a,s){const r=s?e[s]:e[`${n}End`],o=e[`${n}Start`]
o&&r&&P(t,{op:"browser",description:a||n,startTimestamp:i+(0,k.XL)(o),endTimestamp:i+(0,k.XL)(r)})}var J=n(8651),Q=n(8142),W=n(98902)
const Z=["localhost",/^\//],K={traceFetch:!0,traceXHR:!0,tracingOrigins:Z,tracePropagationTargets:Z}
function V(t){const{traceFetch:e,traceXHR:n,tracePropagationTargets:i,tracingOrigins:a,shouldCreateSpanForRequest:s}={traceFetch:K.traceFetch,traceXHR:K.traceXHR,...t},r="function"==typeof s?s:t=>!0,o=t=>function(t,e){return(0,W.U0)(t,e||Z)}(t,i||a),c={}
e&&(0,Q.o)("fetch",(t=>{!function(t,e,n,i){if(!(0,k.zu)()||!t.fetchData||!e(t.fetchData.url))return
if(t.endTimestamp){const e=t.fetchData.__span
if(!e)return
const n=i[e]
return void(n&&(t.response?n.setHttpStatus(t.response.status):t.error&&n.setStatus("internal_error"),n.finish(),delete i[e]))}const a=(0,J.Gd)().getScope(),s=a&&a.getSpan(),r=s&&s.transaction
...
t.args[1]=t.args[1]||{}
const o=t.args[1]
n(t.fetchData.url)&&(o.headers=function(t,e,n,i){const a=(0,D.IQ)(e),s=n.toTraceparent(),r="undefined"!=typeof Request&&(0,_.V9)(t,Request)?t.headers:i.headers
if(r){if("undefined"!=typeof Headers&&(0,_.V9)(r,Headers)){const t=new Headers(r)
return t.append("sentry-trace",s),a&&t.append(D.bU,a),t}if(Array.isArray(r)){const t=[...r,["sentry-trace",s]]
return a&&t.push([D.bU,a]),t}{const t="baggage"in r?r.baggage:void 0,e=[]
return Array.isArray(t)?e.push(...t):t&&e.push(t),a&&e.push(a),{...r,"sentry-trace":s,baggage:e.length>0?e.join(","):void 0}}}return{"sentry-trace":s,baggage:a}}(a,r.getDynamicSamplingContext(),e,o),r.metadata.propagations++)}}(t,r,o,c)})),n&&(0,Q.o)("xhr",(t=>{!function(t,e,n,i){if(!(0,k.zu)()||t.xhr&&t.xhr.__sentry_own_request__||!(t.xhr&&t.xhr.__sentry_xhr__&&e(t.xhr.__sentry_xhr__.url)))return
const a=t.xhr.__sentry_xhr__
if(t.endTimestamp){const e=t.xhr.__sentry_xhr_span_id__
if(!e)return
const n=i[e]
return void(n&&(n.setHttpStatus(a.status_code),n.finish(),delete i[e]))}const s=(0,J.Gd)().getScope(),r=s&&s.getSpan(),o=r&&r.transaction
...
i&&t.xhr.setRequestHeader(D.bU,i),o.metadata.propagations++}catch(t){}}}(t,r,o,c)}))}const tt="BrowserTracing",et={idleTimeout:B.nT,finalTimeout:B.mg,heartbeatInterval:B.hd,markBackgroundTransactions:!0,routingInstrumentation:function(t){let e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=!(arguments.length>2&&void 0!==arguments[2])||arguments[2]
if(!G||!G.location)return void(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.warn("Could not initialize routing instrumentation due to invalid location"))
let i,a=G.location.href
e&&(i=t({name:G.location.pathname,op:"pageload",metadata:{source:"url"}})),n&&(0,Q.o)("history",(e=>{let{to:n,from:s}=e
void 0===s&&a&&-1!==a.indexOf(n)?a=void 0:s!==n&&(a=void 0,i&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log(`[Tracing] Finishing current transaction with op: ${i.op}`),i.finish()),i=t({name:G.location.pathname,op:"navigation",metadata:{source:"url"}}))}))},startTransactionOnLocationChange:!0,startTransactionOnPageLoad:!0,enableLongTask:!0,_experiments:{},...K}
class nt{__init(){this.name=tt}constructor(t){nt.prototype.__init.call(this),this.options={...et,...t},void 0!==this.options._experiments.enableLongTask&&(this.options.enableLongTask=this.options._experiments.enableLongTask),t&&!t.tracePropagationTargets&&t.tracingOrigins&&(this.options.tracePropagationTargets=t.tracingOrigins),function(){const t=q()
t&&U.Z1&&(t.mark&&G.performance.mark("sentry-tracing-init"),(t=>{const e=A("CLS",0)
let n,i=0,a=[]
const s=t=>{t.forEach((t=>{if(!t.hadRecentInput){const s=a[0],r=a[a.length-1]
i&&0!==a.length&&t.startTime-r.startTime<1e3&&t.startTime-s.startTime<5e3?(i+=t.value,a.push(t)):(i=t.value,a=[t]),i>e.value&&(e.value=i,e.entries=a,n&&n())}}))},r=C("layout-shift",s)
r&&(n=Y(t,e),O((()=>{s(r.takeRecords()),n(!0)})))})((t=>{const e=t.entries.pop()
e&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding CLS"),z.cls={value:t.value,unit:""},F=e)})),(t=>{const e=$(),n=A("LCP")
let i
const a=t=>{const a=t[t.length-1]
if(a){const t=Math.max(a.startTime-I(),0)
t<e.firstHiddenTime&&(n.value=t,n.entries=[a],i())}},s=C("largest-contentful-paint",a)
if(s){i=Y(t,n)
const e=()=>{L[n.id]||(a(s.takeRecords()),s.disconnect(),L[n.id]=!0,i(!0))};["keydown","click"].forEach((t=>{addEventListener(t,e,{once:!0,capture:!0})})),O(e,!0)}})((t=>{const e=t.entries.pop()
e&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding LCP"),z.lcp={value:t.value,unit:"millisecond"},H=e)})),(t=>{const e=$(),n=A("FID")
let i
const a=t=>{t.startTime<e.firstHiddenTime&&(n.value=t.processingStart-t.startTime,n.entries.push(t),i(!0))},s=t=>{t.forEach(a)},r=C("first-input",s)
i=Y(t,n),r&&O((()=>{s(r.takeRecords()),r.disconnect()}),!0)})((t=>{const e=t.entries.pop()
if(!e)return
const n=(0,k.XL)(U.Z1),i=(0,k.XL)(e.startTime);("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FID"),z.fid={value:t.value,unit:"millisecond"},z["mark.fid"]={value:n+i,unit:"second"}})))}(),this.options.enableLongTask&&C("longtask",(t=>{for(const e of t){const t=(0,k.x1)()
if(!t)return
const n=(0,k.XL)(U.Z1+e.startTime),i=(0,k.XL)(e.duration)
...
n((t=>this._createRouteTransaction(t)),a,i),s&&(G&&G.document?G.document.addEventListener("visibilitychange",(()=>{const t=(0,k.x1)()
if(G.document.hidden&&t){const e="cancelled";("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log(`[Tracing] Transaction: ${e} -> since tab moved to the background, op: ${t.op}`),t.status||t.setStatus(e),t.setTag("visibilitychange","document.hidden"),t.finish()}})):("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.warn("[Tracing] Could not set up background tab detection due to lack of global document")),p.enableInteractions&&this._registerInteractionListener(),V({traceFetch:o,traceXHR:c,tracePropagationTargets:_,shouldCreateSpanForRequest:d})}_createRouteTransaction(t){if(!this._getCurrentHub)return void(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.warn(`[Tracing] Did not create ${t.op} transaction because _getCurrentHub is invalid.`))
const{beforeNavigate:e,idleTimeout:n,finalTimeout:i,heartbeatInterval:s}=this.options,o="pageload"===t.op,c=o?it("sentry-trace"):null,_=o?it("baggage"):null,d=c?(0,b.q)(c):void 0,p=_?(0,D.EN)(_):void 0,l={...t,...d,metadata:{...t.metadata,dynamicSamplingContext:d&&!p?{}:p},trimEnd:!0},u="function"==typeof e?e(l):l,h=void 0===u?{...l,sampled:!1}:u
...
const m=this._getCurrentHub(),{location:g}=G,f=(0,a.lb)(m,h,n,i,!0,{location:g},s)
return f.registerBeforeFinishCallback((t=>{!function(t){const e=q()
if(!e||!G.performance.getEntries||!U.Z1)return;("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Tracing] Adding & adjusting spans using Performance API")
const n=(0,k.XL)(U.Z1),i=e.getEntries()
let a,s
if(i.slice(j).forEach((e=>{const i=(0,k.XL)(e.startTime),o=(0,k.XL)(e.duration)
if(!("navigation"===t.op&&n+i<t.startTimestamp))switch(e.entryType){case"navigation":!function(t,e,n){["unloadEvent","redirect","domContentLoadedEvent","loadEvent","connect"].forEach((i=>{X(t,e,i,n)})),X(t,e,"secureConnection",n,"TLS/SSL","connectEnd"),X(t,e,"fetch",n,"cache","domainLookupStart"),X(t,e,"domainLookup",n,"DNS"),function(t,e,n){P(t,{op:"browser",description:"request",startTimestamp:n+(0,k.XL)(e.requestStart),endTimestamp:n+(0,k.XL)(e.responseEnd)}),P(t,{op:"browser",description:"response",startTimestamp:n+(0,k.XL)(e.responseStart),endTimestamp:n+(0,k.XL)(e.responseEnd)})}(t,e,n)}(t,e,n),a=n+(0,k.XL)(e.responseStart),s=n+(0,k.XL)(e.requestStart)
break
case"mark":case"paint":case"measure":{!function(t,e,n,i,a){const s=a+n,r=s+i
P(t,{description:e.name,endTimestamp:r,op:e.entryType,startTimestamp:s})}(t,e,i,o,n)
const a=$(),s=e.startTime<a.firstHiddenTime
"first-paint"===e.name&&s&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FP"),z.fp={value:e.startTime,unit:"millisecond"}),"first-contentful-paint"===e.name&&s&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FCP"),z.fcp={value:e.startTime,unit:"millisecond"})
break}case"resource":{const a=e.name.replace(G.location.origin,"")
...
const o=s+i
P(t,{description:n,endTimestamp:o+a,op:e.initiatorType?`resource.${e.initiatorType}`:"resource.other",startTimestamp:o,data:r})}(t,e,a,i,o,n)
break}}})),j=Math.max(i.length-1,0),function(t){const e=G.navigator
if(!e)return
const n=e.connection
n&&(n.effectiveType&&t.setTag("effectiveConnectionType",n.effectiveType),n.type&&t.setTag("connectionType",n.type),M(n.rtt)&&(z["connection.rtt"]={value:n.rtt,unit:"millisecond"})),M(e.deviceMemory)&&t.setTag("deviceMemory",`${e.deviceMemory} GB`),M(e.hardwareConcurrency)&&t.setTag("hardwareConcurrency",String(e.hardwareConcurrency))}(t),"pageload"===t.op){"number"==typeof a&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding TTFB"),z.ttfb={value:1e3*(a-t.startTimestamp),unit:"millisecond"},"number"==typeof s&&s<=a&&(z["ttfb.requestTime"]={value:1e3*(a-s),unit:"millisecond"})),["fcp","fp","lcp"].forEach((e=>{if(!z[e]||n>=t.startTimestamp)return
const i=z[e].value,a=n+(0,k.XL)(i),s=Math.abs(1e3*(a-t.startTimestamp)),o=s-i;("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log(`[Measurements] Normalized ${e} from ${i} to ${s} (${o})`),z[e].value=s}))
const e=z["mark.fid"]
e&&z.fid&&(P(t,{description:"first input delay",endTimestamp:e.value+(0,k.XL)(z.fid.value),op:"ui.action",startTimestamp:e.value}),delete z["mark.fid"]),"fcp"in z||delete z.cls,Object.keys(z).forEach((e=>{t.setMeasurement(e,z[e].value,z[e].unit)})),function(t){H&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding LCP Data"),H.element&&t.setTag("lcp.element",(0,N.Rt)(H.element)),H.id&&t.setTag("lcp.id",H.id),H.url&&t.setTag("lcp.url",H.url.trim().slice(0,200)),t.setTag("lcp.size",H.size)),F&&F.sources&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding CLS Data"),F.sources.forEach(((e,n)=>t.setTag(`cls.source.${n+1}`,(0,N.Rt)(e.node)))))}(t)}H=void 0,F=void 0,z={}}(t)})),f}_registerInteractionListener(){let t
...
const o=this._getCurrentHub(),{location:c}=G,_={name:this._latestRouteName,op:s,trimEnd:!0,metadata:{source:this._latestRouteSource||"url"}}
t=(0,a.lb)(o,_,e,n,!0,{location:c},i)};["click"].forEach((t=>{addEventListener(t,e,{once:!1,capture:!0})}))}}function it(t){const e=(0,N.qT)(`meta[name=${t}]`)
return e?e.getAttribute("content"):null}var at,st=n(20484)
!function(t){t.Ok="ok",t.DeadlineExceeded="deadline_exceeded",t.Unauthenticated="unauthenticated",t.PermissionDenied="permission_denied",t.NotFound="not_found",t.ResourceExhausted="resource_exhausted",t.InvalidArgument="invalid_argument",t.Unimplemented="unimplemented",t.Unavailable="unavailable",t.InternalError="internal_error",t.UnknownError="unknown_error",t.Cancelled="cancelled",t.AlreadyExists="already_exists",t.FailedPrecondition="failed_precondition",t.Aborted="aborted",t.OutOfRange="out_of_range",t.DataLoss="data_loss"}(at||(at={}))
var rt=n(21535);("undefined"==typeof __SENTRY_TRACING__||__SENTRY_TRACING__)&&(0,a.ro)()},20484:(t,e,n)=>{n.d(e,{Dr:()=>c,Zd:()=>_,gB:()=>o})
...
//# sourceMappingURL=chunk.79.ec143a398298020c87e6.map